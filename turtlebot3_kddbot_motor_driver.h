...
#ifndef TURTLEBOT3_KDDBOT_MOTOR_DRIVER_H_
#define TURTLEBOT3_KDDBOT_MOTOR_DRIVER_H_
...
#define KDDBOT_DXL_LIMIT_MAX_VELOCITY            285     // MAX RPM is 65 when MX is powered 12.0V
...
//Do not need to chane this value if using Dynamixel motor
#define VELOCITY_CONSTANT_VALUE         41.69988757710309  // V = r * w = r     *        (RPM             * 0.10472)
...
#endif // TURTLEBOT3_KDDBOT_MOTOR_DRIVER_H_
