...
#include <TurtleBot3Kddbot.h>
#include "turtlebot3_kddbot_motor_driver.h"

#include "turtlebot3_kddbot.h"
...
#define TICK2RAD                         0.001533981  // 0.087890625[deg] * 3.14159265359 / 180 = 0.001533981f  (0.087890625[deg] = 360/4096[Resolution])

#define TEST_DISTANCE                    1.0     // meter
...
int32_t last_diff_tick[WHEEL_NUM] = {0.0, 0.0, 0.0, 0.0};
