...
//hptsai
      typedef int32_t _bleft_encoder_type;
      _bleft_encoder_type bleft_encoder;
      typedef int32_t _bright_encoder_type;
      _bright_encoder_type bright_encoder;
...
//hptsai
      enum { ERROR_BLEFT_MOTOR =  3 };
      enum { ERROR_BRIGHT_MOTOR =  4 };
 ...
 //hptsai    
      ...
      u_bleft_encoder.real = this->bleft_encoder;
      *(outbuffer + offset + 0) = (u_bleft_encoder.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_bleft_encoder.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_bleft_encoder.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_bleft_encoder.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->bleft_encoder);
      ...
      *(outbuffer + offset + 3) = (u_right_encoder.base >> (8 * 3)) & 0xFF;
      ...
      u_bright_encoder.real = this->bright_encoder;
      *(outbuffer + offset + 0) = (u_bright_encoder.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_bright_encoder.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_bright_encoder.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_bright_encoder.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->bright_encoder);
...
//hptsai
      ...
      u_bleft_encoder.base = 0;
      u_bleft_encoder.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_bleft_encoder.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_bleft_encoder.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_bleft_encoder.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->bleft_encoder = u_bleft_encoder.real;
      offset += sizeof(this->bleft_encoder);
...
//hptsai
      ...
      u_bright_encoder.base = 0;
      u_bright_encoder.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_bright_encoder.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_bright_encoder.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_bright_encoder.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->bright_encoder = u_bright_encoder.real;
      offset += sizeof(this->bright_encoder);
